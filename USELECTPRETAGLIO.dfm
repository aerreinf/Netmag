object frmSelectPretaglio: TfrmSelectPretaglio
  Left = 191
  Top = 110
  Width = 795
  Height = 459
  Caption = 'Seleziona Pretaglio'
  Color = clBtnFace
  ...
  object IBQuery1: TIBQuery
    ...
    object IBQuery1PK_DIST: TIntegerField
      FieldName = 'PK_DIST'
    ...
    object IBQuery1G1: TIBStringField
      FieldName = 'G1'
      Origin = '"PRETAGLIO"."G1"'
      Size = 5
    end
    object IBQuery1G2: TIBStringField
      FieldName = 'G2'
      Origin = '"PRETAGLIO"."G2"'
      Size = 5
    end
    object IBQuery1G3: TIBStringField
      FieldName = 'G3'
      Origin = '"PRETAGLIO"."G3"'
      Size = 5
    end
    object IBQuery1G4: TIBStringField
      FieldName = 'G4'
      Origin = '"PRETAGLIO"."G4"'
      Size = 5
    end
    object IBQuery1G5: TIBStringField
      FieldName = 'G5'
      Origin = '"PRETAGLIO"."G5"'
      Size = 5
    end
    object IBQuery1G6: TIBStringField
      FieldName = 'G6'
      Origin = '"PRETAGLIO"."G6"'
      Size = 5
    end
    object IBQuery1G7: TIBStringField
      FieldName = 'G7'
      Origin = '"PRETAGLIO"."G7"'
      Size = 5
    end
    object IBQuery1G8: TIBStringField
      FieldName = 'G8'
      Origin = '"PRETAGLIO"."G8"'
      Size = 5
    end
    object IBQuery1G0: TIBStringField
      FieldName = 'G0'
      Origin = '"PRETAGLIO"."G0"'
      Size = 5
    end
    object IBQuery1H1: TIBStringField
      FieldName = 'H1'
      Origin = '"PRETAGLIO"."H1"'
      Size = 5
    end
    object IBQuery1H2: TIBStringField
      FieldName = 'H2'
      Origin = '"PRETAGLIO"."H2"'
      Size = 5
    end
    object IBQuery1H3: TIBStringField
      FieldName = 'H3'
      Origin = '"PRETAGLIO"."H3"'
      Size = 5
    end
    object IBQuery1H4: TIBStringField
      FieldName = 'H4'
      Origin = '"PRETAGLIO"."H4"'
      Size = 5
    end
    object IBQuery1H5: TIBStringField
      FieldName = 'H5'
      Origin = '"PRETAGLIO"."H5"'
      Size = 5
    end
    object IBQuery1H6: TIBStringField
      FieldName = 'H6'
      Origin = '"PRETAGLIO"."H6"'
      Size = 5
    end
    object IBQuery1H7: TIBStringField
      FieldName = 'H7'
      Origin = '"PRETAGLIO"."H7"'
      Size = 5
    end
    object IBQuery1H8: TIBStringField
      FieldName = 'H8'
      Origin = '"PRETAGLIO"."H8"'
      Size = 5
    end
    object IBQuery1H0: TIBStringField
      FieldName = 'H0'
      Origin = '"PRETAGLIO"."H0"'
      Size = 5
    end
